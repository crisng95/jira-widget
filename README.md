...
<p align="center">
  <img src="docs/panel.png" alt="Jira Widget — panel hiển thị active sprint trên desktop macOS" width="360">
</p>
...
1. Tải `Jira-Widget_x.y.z_aarch64.dmg` ở trang
   **[Releases](https://github.com/crisng95/jira-widget/releases)**.
2. Mở file `.dmg`, kéo **Jira Widget** vào thư mục **Applications**.
3. App **chưa notarize** (không có tài khoản Apple Developer) nên macOS chặn ở lần
   mở đầu — trên macOS mới báo **"Jira Widget is damaged and can't be opened"**.
   Đây **không** phải file hỏng. Sau khi kéo vào Applications, chạy một lần:

   ```bash
   xattr -dr com.apple.quarantine "/Applications/Jira Widget.app"
   ```
